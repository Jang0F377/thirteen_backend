...
class GameState:
    ...
    def has_all_passed(self) -> bool:
        return len(self.passed_players) == len(self.players_state) - 1

    def get_new_leader_idx(self) -> int:
    ...
    def add_to_played_pile(self, cards: list[Card]) -> None:
