...
from thirteen_backend.services.websocket_manager import websocket_manager
...
async def websocket_endpoint(
    ...
    await websocket_manager.connect(session_id=session_id, ws=ws)
    ...
    while True:
        try:
            ...
            if msg_type == "PLAY":
                ...
                await websocket_manager.broadcast(session_id=session_id, message={"type": "JOIN", "player_id": player_id})
            elif msg_type == "LEAVE":
                pass
            else:
